...
function addVariant() {
    ...
    newVariant.innerHTML = `
        ...
        <button type="button" onclick="this.closest('.variant-item').remove()" class="absolute top-2 right-2 h-6 w-6 bg-red-600 text-white rounded-full hover:bg-red-700 flex items-center justify-center" style="border-radius: 50% !important;">
