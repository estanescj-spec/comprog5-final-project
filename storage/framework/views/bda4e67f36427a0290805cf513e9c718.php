        ...
        <?php if(Route::has('register')): ?>
            <div class="mt-6 text-center border-t border-gray-200 pt-5">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="font-semibold text-blue-700 hover:text-blue-900 underline">
                        Register here
                    </a>
                </p>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\skincare\resources\views/auth/login.blade.php ENDPATH**/ ?>