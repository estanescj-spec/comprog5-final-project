                             ...
                             onkeydown="if(event.key==='Enter' || event.key===' '){ event.preventDefault(); window.location.href=this.dataset.href; }">
                                ...
                                <?php endif; ?>
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                        ...
                                        <form method="POST" action="<?php echo e($isFavorited ? route('favorites.destroy', $product) : route('favorites.store')); ?>" class="absolute top-2 right-2 z-10">
                                            <?php echo csrf_field(); ?>
                                            <?php if($isFavorited): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skincare\resources\views/products/index.blade.php ENDPATH**/ ?>