                    ...
                    <table id="ratingsTable" class="min-w-full text-sm">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $ratings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="font-medium text-gray-900"><?php echo e($rating->product->name); ?></td>
                                    <td class="text-gray-700"><?php echo e($rating->user->name); ?></td>
                                    <td>
                                        <span class="stars-display">
                                            ...
                                            <?php endfor; ?>
                                            <span class="ml-1 text-xs text-gray-500">(<?php echo e($rating->rating); ?>/5)</span>
                                        </span>
                                    </td>
                                    <td class="comment-cell text-sm text-gray-700"><?php echo e($rating->comment ?: '—'); ?></td>
                                    <td>
                                        <?php if($rating->photo_path): ?>
                                            <img src="<?php echo e(asset('storage/' . $rating->photo_path)); ?>" alt="Review photo" class="h-12 w-12 object-cover rounded-lg border border-gray-200">
                                        <?php else: ?>
                                            <span class="text-xs text-gray-400">—</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-xs text-gray-500"><?php echo e($rating->created_at->format('M d, Y')); ?></td>
                                    <td>
                                        <form method="POST" action="<?php echo e(route('admin.ratings.destroy', $rating)); ?>" style="display: inline;">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="submit" data-confirm="Delete this review by <?php echo e($rating->user->name); ?>?" data-confirm-label="Delete"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\comprog5-final-project-main\resources\views/admin/ratings/index.blade.php ENDPATH**/ ?>