<?php $__env->startSection('header'); ?>
    <div class="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
        ...
        <a href="<?php echo e(route('admin.products.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white text-sm font-medium rounded-full hover:bg-blue-800" style="border-radius: 0.375rem !important;">
            + Add Product
        </a>
    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl">
                <div class="p-6 text-gray-900 space-y-4">
                    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <form method="POST" action="<?php echo e(route('admin.products.import')); ?>" enctype="multipart/form-data" class="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-2">
                            <?php echo csrf_field(); ?>
                    ...
                    <div class="flex items-center gap-2 border-b pb-3">
                        <button id="tab-active-products" type="button" onclick="showProductTab('active')" class="px-3 py-1.5 rounded-full text-xs font-medium bg-blue-500 text-white" style="border-radius: 0.375rem !important;">
                            Active (<?php echo e($products->count()); ?>)
                        </button>
                        <button id="tab-trashed-products" type="button" onclick="showProductTab('trash')" class="px-3 py-1.5 rounded-full text-xs font-medium bg-gray-100 text-gray-700" style="border-radius: 0.375rem !important;">
                            Trash (<?php echo e($trashedProducts->count()); ?>)
                        </button>
                    </div>
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b last:border-0" style="vertical-align: middle; text-align: center;">
                                            ...
                                            <?php
                                                $adminCardImage = ($product->images && $product->images->isNotEmpty())
                                                    ...
                                                    : ($product->variants->firstWhere('image', '!=', null)?->image
                                                        ...
                                                        : null);
                                            ?>
                                            <?php if($adminCardImage): ?>
                                                <div class="h-12 w-12 overflow-hidden rounded-md flex-shrink-0 mx-auto">
                                                    <img src="<?php echo e($adminCardImage); ?>" alt="<?php echo e($product->name); ?>" class="h-full w-full object-cover">
                                                </div>
                                            <?php else: ?>
                                        ...
                                        <td class="py-2 px-4 text-left">
                                            ...
                                            <div class="text-xs text-gray-500 truncate max-w-xs"><?php echo e(Str::limit($product->description, 50)); ?></div>
                                        </td>

                                        <td class="py-2 px-4 whitespace-nowrap">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-900">
                                                <?php echo e($product->categories->pluck('name')->join(', ') ?: 'No Category'); ?>

                                            </span>
                                        </td>

                                        <td class="py-2 px-4 whitespace-nowrap font-medium">
                                            ₱<?php echo e(number_format($product->variants->min('price') ?? 0, 2)); ?>

                                        </td>

                                        <td class="py-2 px-4 whitespace-nowrap">
                                            <span class="text-gray-600"><?php echo e($product->variants_count); ?></span>
                                        </td>
                                        ...
                                        <td class="py-2 px-4 whitespace-nowrap font-medium text-gray-700">
                                            <?php echo e((int) ($product->units_sold ?? 0)); ?>
                                        ...
                                        <td class="py-2 px-4 whitespace-nowrap">
                                            <div class="flex flex-wrap gap-2 justify-center">
                                                ...
                                                <form method="POST" action="<?php echo e(route('admin.products.destroy', $product)); ?>" class="inline-block">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="submit" data-confirm="Move '<?php echo e($product->name); ?>' to trash?" data-confirm-label="Move to Trash"
                    ...
                    <div id="trashed-products-section" class="overflow-x-auto hidden">
                        <table id="trashed-products-table" class="min-w-full text-sm">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $trashedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b last:border-0" style="vertical-align: middle; text-align: center;">
                                        <td class="py-2 px-4 whitespace-nowrap">
                                            <?php
                                                $trashedCardImage = ($product->images && $product->images->isNotEmpty())
                                                    ...
                                                    : ($product->variants->firstWhere('image', '!=', null)?->image
                                                        ...
                                                        : null);
                                            ?>
                                            <?php if($trashedCardImage): ?>
                                                <div class="h-12 w-12 overflow-hidden rounded-md flex-shrink-0 mx-auto">
                                                    <img src="<?php echo e($trashedCardImage); ?>" alt="<?php echo e($product->name); ?>" class="h-full w-full object-cover">
                                                </div>
                                            <?php else: ?>
                                                <div class="h-12 w-12 rounded-md bg-gray-100 flex items-center justify-center text-gray-400 flex-shrink-0 mx-auto">
                                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <td class="py-2 px-4 whitespace-nowrap"><?php echo e($product->variants_count); ?></td>
                                        ...
                                        <td class="py-2 px-4 whitespace-nowrap font-medium text-gray-700"><?php echo e((int) ($product->units_sold ?? 0)); ?></td>

                                        <td class="py-2 px-4 whitespace-nowrap text-xs text-gray-500"><?php echo e(optional($product->deleted_at)->format('M d, Y h:i A')); ?></td>
                                        <td class="py-2 px-4 whitespace-nowrap">
                                            <form method="POST" action="<?php echo e(route('admin.products.restore', $product->id)); ?>" class="inline-block">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\comprog5-final-project-main\resources\views/admin/products/index.blade.php ENDPATH**/ ?>